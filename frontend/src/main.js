...
const toastMap = [
  ...
  [/coupon not found/i, '优惠码不存在'],
  [/coupon expired/i, '优惠券已过期'],
  [/coupon not active/i, '优惠券已停用'],
  [/coupon used up/i, '优惠券已领完'],
  [/coupon already used/i, '您已使用过该优惠券'],
  [/coupon min order/i, '未达到优惠券使用门槛'],
  [/coupon code exists/i, '优惠码已存在']
];
